  ...
  return (
    <div className="max-w-2xl mx-auto">
      ...
      <div className="flex flex-col items-center justify-center min-h-[400px] text-center">
        ...
        <h2 className="text-xl font-semibold text-slate-900 mb-2">Image Generation Coming Soon</h2>
        <p className="text-slate-500 max-w-md">
          AI-powered illustrations, graphics, and banners are launching soon. Stay tuned.
        </p>
      </div>
    </div>
  )
